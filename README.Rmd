...
```{r visium-random-field, fig.width=7, fig.height=5, fig.cap="Visium B mt_co3 fitted PC-truncated SPDE random field from mgcViz.", fig.alt="Fitted spatial random field for mt_co3 in Visium B."}
