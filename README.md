...
```
    ...
    ##      slice spots                     genes
    ## 1 MISO_E13   219    Mapt, Map1b, Hist1h2ao
    ## 2 Visium_B  2125 mt_co3, mt_co2, BRAFhuman

The package stores the original spatial coordinates and expression at
each included spot. The maps below display all observed spots, coloured
...
<img src="README_files/figure-gfm/visium-random-field-1.png" alt="Fitted spatial random field for mt_co3 in Visium B."  />
<p class="caption">

Visium B mt_co3 fitted PC-truncated SPDE random field from mgcViz.
</p>
...
the two scripts below. Each script writes fit diagnostics, pair results,
and compact R objects to `MGCVST_EXAMPLE_OUTPUT`.
